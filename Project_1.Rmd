...
## c)
Since variance and squared expression cannot be negative each of the three terms contributes to the expected test MSE at $x_0$. The $\pmb{\mathrm{Var}[ \epsilon ]}$ is the **irreducible error**. It is independent of the model and cannot be reduced. 
