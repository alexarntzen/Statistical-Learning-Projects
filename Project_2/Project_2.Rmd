...
$$
where $X$ is the data matrix, $y$ is the measured response and $\hat{\beta}_0 = \overline{y}$ is the intercept estimate. As $\hat{\beta}_0$ is known, we can center the columns of $X$ and $y$, and  exclude the intercept column from $X$. This results in the equvilant problem. 
...
## b)
The basis functions for the cubic spline with knots the quantiles $q_1$, $q_2$ and $q_3$ are
$$
\begin{aligned}
